    ...
    return (
        <Container>
            <footer className="bg-white by-4 mt-3 mb-3 m-lr-5">
                <div className="row">
                    <div className="col-lg-10 col-md-12 d-flex justify-content-lg-start justify-content-md-center justify-content-sm-center">
                    ...
                    <div className="col-lg-2 col-md-12 d-flex justify-content-lg-end justify-content-sm-center ">
                        ...
                        <div className="px-1"> <svg className="icon icon--full-color" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width="38" height="24" aria-labelledby="pi-visa">
        ...
        <Container>
            <footer className="bg-white by-4 mt-3 mb-3 m-lr-5">
                <div className="row">
                    <div className="col-lg-10 col-md-12 d-flex justify-content-lg-start justify-content-md-center justify-content-sm-center">
                        <p className="  m-0 fs-xl mt-auto align-items-center m-right-left-2 fw-bolder">
                            © 2023 , <span className="hov"> Phono (password: buddha) </span> <span className="hov">Design Themes
                          </span>
                        </p>
                    </div>

                    <div className="col-lg-2 col-md-12 d-flex justify-content-lg-end justify-content-md-center justify-content-sm-center ">
                        <span className="visually-hidden">Payment methods</span>
                        ...
                        <svg className="icon icon--full-color" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img"
                             width="38" height="24" aria-labelledby="pi-diners_club"><title id="pi-diners_club">Diners Club</title>
                            <path opacity=".07"
                                  d="M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z"></path>
                            <path fill="#fff"
                                  d="M35 1c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2h32"></path>
