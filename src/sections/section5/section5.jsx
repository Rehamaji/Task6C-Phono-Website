        ...
        <section className="mx-5">
          ...
          <Headers first="INNOVATIVE QUALITIES & FEATURES" second="SHOW YOURS TO THE WORLD"/>
            ...
            <div className="row justify-content-around pt-5 justify-content-between">
                <div className="card mb-3 card border-0 col-xl-4 col-md-6 order-xl-1 order-sm-2">
                ...
                <div className="card border-0           col-xl-4 col-lg-12 order-xl-2  order-sm-1 ">
                    <img src={Iphone14}
                          sizes="(min-width: 1300px) 600px, (min-width: 750px) calc((100vw - 130px) / 2), calc((100vw - 50px) / 2)"
                         className="m-auto"
                         alt="" loading="lazy" width="381" height="551"/>
                </div>
                <div className="card mb-3 card border-0 col-xl-4 col-md-6 order-xl-3 order-sm-3">
